...
if __name__ == '__main__':
    ...
    H_1 = solve_homography(corners1, ref_corns)
    H_2 = solve_homography(corners2, ref_corns) 
    output3_1 = warping(secret1, dst, H_1, 0, w, 0, h, direction='b')
    output3_2 = warping(secret2, dst_2, H_2, 0, w, 0, h, direction='b')
